...
function Navbar() {
  ...
  return (
    <div className=" dark:bg-[#171717] flex justify-between items-center py-6 px-6 md:px-9 font-semibold dark:text-white tracking-[4px] text-sm">
      ...
      <div className="flex space-x-2 items-center">
        {renderThemeChanger()}
        <button className="text-xs tracking-wider dark:text-[#BAC1D4] dark:bg-[#1C1D1D] px-2 py-1 md:px-4 md:py-2 rounded-full border-2 border-[#2E2E2E]/30 duration-700 hover:bg-yellow-500 hover:text-black dark: hover:bg-yellow-500 dark: hover:text-black">
          CONTACT US
        </button>
